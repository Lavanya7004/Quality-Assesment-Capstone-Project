...
const AdminRolesPanel = () => {
  ...
  const updateUserRole = async (userId: string, newRole: 'student' | 'professor' | 'admin') => {
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{users.filter(u => u.role === 'professor').length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="flex gap-2">
                  ...
                  {user.role !== 'professor' && (
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => updateUserRole(user.user_id, 'professor')}
                      disabled={user.user_id === currentUserId}
                      className="whitespace-nowrap"
                    >
